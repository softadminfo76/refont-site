          ...
          <nav class="mt-2" aria-label="Main navigation">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('ui.general') }}" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>General</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="{{ route('ui.colors') }}" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Colors</p>
                    </a>
                  </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">General UI Elements</h1>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-md-6">
                ...
                <div class="card card-danger card-outline mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <p class="fs-7 text-secondary mt-2 mb-2">
                      The warning, info and light outlines draw their text in a light colour, which
                      drops below the 4.5:1 contrast minimum on a light surface. Put them on a dark
                      one:
                    </p>
                ...
                <div class="card card-primary card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header">
                    <div class="card-title">Nav Tabs &amp; Pills</div>
                  </div>
                  <!--end::Header-->
                  <!--begin::Body-->
                  <div class="card-body">
                    <ul class="nav nav-tabs" id="demoTab" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button
                          ...
                          id="demo-home-tab"
                          data-bs-toggle="tab"
                          data-bs-target="#demo-home"
                          type="button"
                          role="tab"
                          aria-controls="demo-home"
                          aria-selected="true"
                        >
                          Home
                        </button>
                      ...
                      <li class="nav-item" role="presentation">
                        <button
                          ...
                          id="demo-profile-tab"
                          data-bs-toggle="tab"
                          data-bs-target="#demo-profile"
                          type="button"
                          role="tab"
                          aria-controls="demo-profile"
                          aria-selected="false"
                        >
                          Profile
                        </button>
                    ...
                    <div class="tab-content border border-top-0 p-3 mb-4">
                      ...
                      <div
                        ...
                        tabindex="0"
                      >
                        Give every trigger a <code>data-bs-target</code> and the matching pane an
                        <code>id</code>.
                      </div>
                      <div
                        class="tab-pane fade"
                        id="demo-settings"
                        role="tabpanel"
                        aria-labelledby="demo-settings-tab"
                        tabindex="0"
                      >
                        Use <code>&lt;button&gt;</code> triggers rather than links: they are
                        focusable without a href and need no <code>preventDefault</code>.
                      </div>
                    </div>

                    <ul class="nav nav-pills" id="demoPill" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button
                          class="nav-link active"
                          id="demo-pill-one-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#demo-pill-one"
                          type="button"
                          role="tab"
                          aria-controls="demo-pill-one"
                          aria-selected="true"
                        >
                          Active
                        </button>
                      ...
                      <li class="nav-item" role="presentation">
                        <button
                          class="nav-link"
                          id="demo-pill-two-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#demo-pill-two"
                          type="button"
                          role="tab"
                          aria-controls="demo-pill-two"
                          aria-selected="false"
                        >
                          Link
                        </button>
                    ...
                    <div class="tab-content pt-3">
                      <div
                        ...
                        id="demo-pill-one"
                        role="tabpanel"
                        aria-labelledby="demo-pill-one-tab"
                        tabindex="0"
                      >
                        Pills use the same markup with
                        <code>data-bs-toggle="pill"</code>.
                      </div>
                      <div
                        class="tab-pane fade"
                        id="demo-pill-two"
                        role="tabpanel"
                        aria-labelledby="demo-pill-two-tab"
                        tabindex="0"
                      >
                        Add <code>.flex-column</code> to the list for a vertical pill nav.
                      </div>
                    </div>
                  </div>
                  <!--end::Body-->
                ...
                <div class="card card-success card-outline mb-4">
                  ...
                  <div class="card-body">
                    <button
                      ...
                      data-bs-target="#demoModalDefault"
                    >
                      Default
                    </button>
                    <button
                      ...
                      data-bs-toggle="modal"
                      data-bs-target="#demoModalScrollable"
                    >
                      Scrollable
                    </button>
                    <button
                      ...
                      data-bs-toggle="modal"
                      data-bs-target="#demoModalFullscreen"
                    >
                      Fullscreen below lg
                    </button>
                    ...
                    <div
                      ...
                      id="demoModalDefault"
                      tabindex="-1"
                      aria-labelledby="demoModalDefaultLabel"
                      aria-hidden="true"
                    >
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="demoModalDefaultLabel">
                              Centered modal
                            </h1>
                            <button
                              type="button"
                          ...
                          <div class="modal-body">
                            <p class="mb-0">
                              <code>.modal-dialog-centered</code> vertically centres the dialog in
                              the viewport.
                            </p>
                          </div>
                    ...
                    <div
                      class="modal fade"
                      id="demoModalScrollable"
                      tabindex="-1"
                      aria-labelledby="demoModalScrollableLabel"
                      aria-hidden="true"
                    >
                      <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="demoModalScrollableLabel">
                              Scrollable body
                            </h1>
                            <button
                              type="button"
                          ...
                          <div class="modal-body">
                            <p>
                              With <code>.modal-dialog-scrollable</code> the body scrolls instead of
                              the page, so the header and footer stay put.
                            </p>
                            <p>
                            ...
                            <p class="mb-0">
                              Donec ullamcorper nulla non metus auctor fringilla. Nullam quis risus
                              eget urna mollis.
                            </p>
                          </div>
                          <div class="modal-footer">
                    ...
                    <div
                      class="modal fade"
                      id="demoModalFullscreen"
                      tabindex="-1"
                      aria-labelledby="demoModalFullscreenLabel"
                      aria-hidden="true"
                    >
                      <div class="modal-dialog modal-fullscreen-lg-down">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="demoModalFullscreenLabel">
                              Fullscreen below lg
                            </h1>
                            <button
                              type="button"
                          ...
                          <div class="modal-body">
                            <p class="mb-0">
                              <code>.modal-fullscreen-lg-down</code> fills the screen on phones and
                              tablets, then falls back to a regular dialog from the
                              <code>lg</code> breakpoint up — a good default for dense admin forms.
                            </p>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                ...
                <div class="card card-info card-outline mb-4">
                  ...
                  <div class="card-body">
                    <p>
                      Offcanvas panels are useful for filters and detail views that would otherwise
                      crowd a dashboard. They are separate from the AdminLTE sidebar, which has its
                      own
                      <code>PushMenu</code> plugin.
                    </p>
                    <button
                      type="button"
                      class="btn btn-primary me-1"
                    ...
                    <button
                      ...
                      class="btn btn-secondary"
                      data-bs-toggle="offcanvas"
                      data-bs-target="#demoOffcanvasBottom"
                      aria-controls="demoOffcanvasBottom"
                    >
                      From the bottom
                    </button>
                      ...
                      <div class="offcanvas-body">
                        ...
                        <div class="form-check">
                          <input
                            ...
                            type="checkbox"
                            id="demoOffcanvasArchived"
                          />
                          <label class="form-check-label" for="demoOffcanvasArchived">
                            Include archived
                          </label>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      tabindex="-1"
                      id="demoOffcanvasBottom"
                      aria-labelledby="demoOffcanvasBottomLabel"
                    >
                      <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="demoOffcanvasBottomLabel">
                          Bottom placement
                        </h5>
                        <button
                          type="button"
                      ...
                      <div class="offcanvas-body">
                        <p class="mb-0">
                          ...
                          <code>.offcanvas-top</code> and <code>.offcanvas-bottom</code>.
                        </p>
                      </div>
                    </div>
                  </div>
