            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('widgets.social') }}" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Social &amp; Post</p>
                    </a>
                  </li>
                ...
                <div class="card mb-0">
                  ...
                  <div class="card-header">
                    <div class="user-block">
                      <img class="rounded-circle" src="{{ asset('vendor/adminlte/assets/img/') }}/user1-128x128.jpg" alt="" />
                      <span class="username">
                  ...
                  <!--begin::Card Body-->
                  <div class="card-body">
                    <img class="img-fluid rounded mb-3" src="{{ asset('vendor/adminlte/assets/img/') }}/photo1.png" alt="" />
                  ...
                  <div class="card-footer">
                    <div class="user-block user-block-sm mb-3">
                      <img class="rounded-circle" src="{{ asset('vendor/adminlte/assets/img/') }}/user4-128x128.jpg" alt="" />
                    ...
                    <div class="user-block user-block-sm">
                      <img class="rounded-circle" src="{{ asset('vendor/adminlte/assets/img/') }}/user5-128x128.jpg" alt="" />
              ...
              <div class="col-lg-6">
                ...
                <div class="card mb-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="rounded-circle" src="{{ asset('vendor/adminlte/assets/img/') }}/user7-128x128.jpg" alt="" />
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="rounded-circle" src="{{ asset('vendor/adminlte/assets/img/') }}/user6-128x128.jpg" alt="" />
                      ...
                      <div class="row g-2 mb-3">
                        <div class="col-4">
                          <img class="img-fluid rounded" src="{{ asset('vendor/adminlte/assets/img/') }}/photo2.png" alt="" />
                        </div>
                        <div class="col-4">
                          <img class="img-fluid rounded" src="{{ asset('vendor/adminlte/assets/img/') }}/photo3.jpg" alt="" />
                        </div>
                        <div class="col-4">
                          <img class="img-fluid rounded" src="{{ asset('vendor/adminlte/assets/img/') }}/photo4.jpg" alt="" />
                        </div>
                      </div>
                      <!--end::Row-->
                      <p class="mb-0">
